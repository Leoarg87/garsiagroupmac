...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <a name="taladros"></a>
            <div class="col-sm">
                <img src="img/global/picapica.png" alt="martillo demoledor" class="img-fluid border rounded">
                <p class="text-center">Martillo Electrico 4kgs picador/perforador </p>
                <?php
                include('whatsappherramientas.html');
                ?>
            </div>
