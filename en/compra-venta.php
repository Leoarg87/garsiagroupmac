...
<Car body>
    ...
    <h1 class="text-center mt-5" style="font-size: xxx-large; font-family: 'Impact';color: white">Garsia Group</h1>
        <h1 class="text-center mt-3" style="color:white"> Your loyalty is our commitment</h1>
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> LAND-ROVER Range Rover Evoque</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2016</li>
                                <li style="list-style-type:disc"> <b>Km:</b> 109.000 km</li>
                                <li style="list-style-type:disc"> <b>Car body:</b> 4x4 SUV</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 5</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 150 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 1998 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 23000€</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> MERCEDES-BENZ Clase C C 220</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2014</li>
                                <li style="list-style-type:disc"> <b>Km:</b> 180.000 km</li>
                                <li style="list-style-type:disc"> <b>Car body:</b> Berlina</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Transmission:</b> Automático</li>
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 4</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 170 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 2143cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 21900€</li>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> FORD Mustang 5.0 TiVCT V8</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2018</li>
                                <li style="list-style-type:disc"> <b>Km:</b> 20.000 km</li>
                                <li style="list-style-type:disc"> <b>Car body:</b> Cabrio</li>
                                <li style="list-style-type:disc"> <b>Color:</b> Granate</li>
                                <li style="list-style-type:disc"> <b>Seats:</b> 4</li>
                            </ul>
                        </div>
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                <li style="list-style-type:disc"> <b>Fuel:</b> Gasolina</li>
                                <li style="list-style-type:disc"> <b>Transmission:</b> Automático</li>
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 2</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 418 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 4951 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 50900€</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> MERCEDES-BENZ Clase E E 220</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2019</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 4</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 194 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 1950 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 37.500 €</li>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> SKODA Fabia 1.2 12v</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2013</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 5</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 60 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 1198 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 5450 €</li>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> MAZDA CX5 2.2</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2014</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Doors:</b> 5</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 150 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 2191 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 15980 €</li>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> VOLKSWAGEN Touran Advance 1.6 TDI</li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2016</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 5</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 115 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 1598 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 18.200 €</li>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> AUDI A8 3.0 TDI </li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2016</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 4</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 262 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 2967 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 39.999 €</li>
            ...
            <div class="modal-content">
                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-center">
                        <div class="col  d-flex justify-content-center">
                            <ul>
                                <li style="list-style-type:disc"> <b>Model:</b> FORD Mustang 2.3 EcoBoost </li>
                                <li style="list-style-type:disc"> <b>Year:</b> 2015</li>
                        ...
                        <div class="col  d-flex justify-content-center ">
                            <ul>
                                ...
                                <li style="list-style-type:disc"> <b>Location:</b> Málaga</li>
                                <li style="list-style-type:disc"> <b>Doors:</b> 2</li>
                                <li style="list-style-type:disc"> <b>HorsePower:</b> 314 cv</li>
                                <li style="list-style-type:disc"> <b>Engine Capacity:</b> 2300 cc</li>
                                <li style="list-style-type:disc"> <b>Price:</b> 21.000 €</li>
