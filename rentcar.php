...
<body>
    ...
    <div class="mt-5" style="background-color:#891A1A">
        ...
        <h3 class="text-center  p-3" style="font-family: 'Impact'; color : white;">y buscamos el automóvil perfecto para ti.</h3>
    </div>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-4">
            <h2 class="text-center" style="color:#891A1A">Alquier de coches en Marbella</h2>
        </div>
        <div class="col-4">
            <h2 class="text-center" style="color:#891A1A">Porque elegirnos</h2>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-4">
            <p class="text-center"> <b>Empresa local dedicada al alquiler de coches sin conductor</b> ubicada en Marbella. <br><br>
                Nuestro concepto es ofrecer la mejor experiencia a nuestros clientes con un trato cercano y amigable, con la finalidad no sólo la colaboración comercial o el alquiler puntual, sino una relación estable de confianza y un <b>servicio personalizado, flexible, sin costes ocultos y con seguro a todo riesgo sin franquicia.</b>
            </p>
        </div>
        <div class="col-4 " style="padding-left:8%">
            <ul>
                <li style="list-style-type:disc">Trato personalizado y cercano</li>
                <li style="list-style-type:disc">Alquiler de coches con precios claros y sin costes ocultos.</li>
                <li style="list-style-type:disc">Vehículos de alquiler con seguro a todo riesgo y sin franquicia.</li>
                <li style="list-style-type:disc">Flota de vehículos propia para alquilar</li>
                <li style="list-style-type:disc">Alquiler de vehículos sin intermediarios.</li>
                <li style="list-style-type:disc">Abrimos nuestras sedes de rent a car todo el año.</li>
                <li style="list-style-type:disc">Coches para alquilar sin ningún tipo de publicidad. Conduce sin anuncios.</li>
                <li style="list-style-type:disc">Servicio personalizado para empresas</li>
            </ul>
        </div>
    </div>
    ...
    <div class="mt-5" style="background-color:#891A1A">
        ...
        <h3 class="text-center  p-3" style="font-family: 'Impact'; color : white;">ALQUILER COCHES MARBELLA GARSIA GROUP</h3>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4 d-flex justify-content-center">
            ...
            <div class="col-3 align-self-center">
                ...
                <span style="font-weight: bold; font-family: 'Poiret One'; font-size:24px">Caracerísticas:<br></span>
                <ul>
                    <li style="list-style-type:disc"> <b>Carrocería:</b> PREMIUM</li>
                    <li style="list-style-type:disc"> <b>Combustible:</b> DIESEL</li>
                    <li style="list-style-type:disc"> <b>Transmisión:</b> Automático</li>
                    <li style="list-style-type:disc"> <b>Asientos:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Puertas:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Capacidad maletas:</b> 3</li>
                    <li style="list-style-type:disc"> <b>Edad para alquilar:</b>23 años</li>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            <div class="col-3 align-self-center">
                ...
                <ul>
                    ...
                    <li style="list-style-type:disc"> <b>Asientos:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Puertas:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Capacidad maletas:</b> 4</li>
                    <li style="list-style-type:disc"> <b>Edad para alquilar:</b> 23 años</li>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            <div class="col-3 align-self-center">
                ...
                <span style="font-weight: bold; font-family: 'Poiret One'; font-size:24px">Caracerísticas:<br></span>
                <ul>
                    <li style="list-style-type:disc"> <b>Carrocería:</b> ECONOMIC</li>
                    <li style="list-style-type:disc"> <b>Combustible:</b> HYBRID/GASOLINA</li>
                    <li style="list-style-type:disc"> <b>Transmisión:</b> Automático</li>
                    <li style="list-style-type:disc"> <b>Asientos:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Puertas:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Capacidad maletas:</b> 3</li>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            <div class="col-3 align-self-center">
                ...
                <span style="font-weight: bold; font-family: 'Poiret One'; font-size:24px">Caracerísticas:<br></span>
                <ul>
                    <li style="list-style-type:disc"> <b>Carrocería:</b> COMPACTO</li>
                    <li style="list-style-type:disc"> <b>Combustible:</b> DIESEL</li>
                    <li style="list-style-type:disc"> <b>Transmisión:</b> Automático</li>
                    <li style="list-style-type:disc"> <b>Asientos:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Puertas:</b> 5</li>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            <div class="col-4 align-self-center">
                ...
                <ul>
                    ...
                    <li style="list-style-type:disc"> <b>Asientos:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Puertas:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Capacidad maletas:</b>Maletero Amplio</li>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            ...
            <div class="col-4 align-self-center">
                ...
                <span style="font-weight: bold; font-family: 'Poiret One'; font-size:24px">Caracerísticas:<br></span>
                <ul>
                    <li style="list-style-type:disc"> <b>Carrocería:</b> FAMILY</li>
                    <li style="list-style-type:disc"> <b>Combustible:</b> DIESEL</li>
                    <li style="list-style-type:disc"> <b>Transmisión:</b> Automático</li>
                    <li style="list-style-type:disc"> <b>Asientos:</b> 7</li>
                    <li style="list-style-type:disc"> <b>Puertas:</b> 5</li>
                    <li style="list-style-type:disc"> <b>Capacidad maletas:</b> 2</li>
                    <li style="list-style-type:disc"> <b>Edad para alquilar:</b> 23 años</li>
        ...
        <a name="furgonetas"></a>
        <h2 class="mt-5" style="text-align: center; color:#ae1102">ALQUILER DE FURGONETAS</h2>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            <div class="col-3 align-self-center">
                ...
                <span style="font-weight: bold; font-family: 'Poiret One'; font-size:24px">Caracerísticas:<br></span>
                <ul>
                    <li style="list-style-type:disc"> <b>Carrocería:</b> FURGONETA</li>
                    <li style="list-style-type:disc"> <b>Combustible:</b> DIESEL</li>
